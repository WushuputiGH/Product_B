...
@property (nonatomic, strong, readwrite) NSData *avatar_l_Data;
@property (nonatomic, strong, readwrite) NSString *avatar_m;
@property (nonatomic, strong, readwrite) NSData *avatar_m_Data;
@property (nonatomic, strong, readwrite) NSString *avatar_s;
@property (nonatomic, strong, readwrite) NSData *avatar_s_Data;
...
@property (nonatomic, strong, readwrite) NSData *coverData;
